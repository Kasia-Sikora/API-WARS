import { fetchMultipleData } from "./api_connection.js";

export function createModalTable(modal_body) {
...
function createModalColumns(data) {
...
export function modalHandling(data){
    ...
    for (let resident of residents){
        if (resident.dataset.name == data){
            ...
            fetchMultipleData(pages, createModalColumns)
        }
    }
}